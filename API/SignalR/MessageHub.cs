...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
            ...
            if(recipient == null) throw new HubException("Not found users ");
        ...
        private async Task<API.Entities.Group> AddToGroup(string groupName)
        {
            var group = await _unitOfWork.MessageRepository.GetMessageGroup(groupName);
            ...
            if(group == null)
            {
                group = new API.Entities.Group(groupName);
        ...
        private async Task<API.Entities.Group> RemoveFromMessageGroup()
        {
            ...
            throw new HubException("Failed to remove");
        }
